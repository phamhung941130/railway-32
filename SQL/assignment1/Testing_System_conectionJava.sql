...
VALUES 				('Email1@gmail.com'				, 'Username1'		,'Fullname1'				,   '5'			,   '1'		,'2020-03-05'),
                    ...
                    ('Email11@gmail.com'			, 'Username11'		,'Fullname11'				,   '10'		,   '1'		, '2020-04-05'),
					('Email12@gmail.com'			, 'Username12'		,'Fullname12'				,   '10'		,   '1'		, '2020-04-05');
                    
                    --
                   --  SELECT * FROM testingsystem.department ORDER BY department;
--                     SELECT * FROM department WHERE DepartmentID = ?;
--                     UPDATE testingsystem.position SET PositionName = Dev WHERE PositionID = 5;
--                     DELETE FROM testingsystem.position WHERE PositionID = 5;
